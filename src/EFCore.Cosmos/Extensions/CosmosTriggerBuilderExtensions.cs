...
{
    /// <summary>
    ///     Configures the trigger type (Pre or Post).
    /// </summary>
    ...
    /// <summary>
    ///     Configures the trigger operation (Create, Replace, Delete, or All).
    /// </summary>
    /// <param name="triggerBuilder">The builder for the trigger being configured.</param>
    /// <param name="triggerOperation">The trigger operation to configure.</param>
    /// <returns>The same builder instance so that multiple configuration calls can be chained.</returns>
    public static TriggerBuilder HasTriggerOperation(this TriggerBuilder triggerBuilder, TriggerOperation triggerOperation)
    {
